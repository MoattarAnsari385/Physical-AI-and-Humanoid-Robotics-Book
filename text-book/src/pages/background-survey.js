...
const BackgroundSurveyPage = () => {
  return (
    <Layout title="Background Survey" description="Complete your background survey for personalized learning">
      <ProtectedRoute>
        <div style={{
          minHeight: '100vh',
...
export default BackgroundSurveyPage;